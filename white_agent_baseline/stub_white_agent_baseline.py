...
def start_stub_white_agent_baseline(
    host: str = "0.0.0.0",
    port: int = 9002,
    orders_csv: str = "../green_agent_demo/dataset/super_shortened_orders_products_combined.csv",
...
if __name__ == "__main__":
    ...
    orders_csv = os.environ.get(
        "ORDERS_CSV",
        os.path.join(os.path.dirname(__file__), "..", "green_agent_demo", "dataset", "super_shortened_orders_products_combined.csv"),
    )
